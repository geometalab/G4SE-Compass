    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_year', models.IntegerField(max_length=4, verbose_name='publication year')),
                ...
                ('metadata_link', models.URLField(max_length=2083, verbose_name='')),
                ('access_link', models.URLField(max_length=2083, verbose_name='')),
