...
class GeoServiceMetadata(models.Model):
    ...
    publication_year = models.IntegerField(_('publication year'), max_length=4)
    ...
    metadata_link = models.URLField(_(''), max_length=2083)
    access_link = models.URLField(_(''), max_length=2083)
