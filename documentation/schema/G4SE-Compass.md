...
| Service-Art                   | Service type                | service_type          | string    | no    |          | format      | x | FeatureService,ImageService,MapService,GeoVITe,WMS,WFS | Service type (KES: more ArcGIS Services missing?)                                                                                |                                            | 
