...
| History                       | Publication lineage         | publication_lineage   | string    | no    |          |             | x |                                           | Comma separated publication   year lineage (passed publications)                                                                 |                                            | 
...
| Geogr. Ausdehnung             | Geographical extent         | extent                | string    | no    |          |             | x |                                           | BBox. Must be WSG84.                                                                                                             |                                            | 
