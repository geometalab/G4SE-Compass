...
| Metadaten Sprache             | Metadata language           | language              | string    | ysy   |          | language    | x |                                           | Language of metadata record                                                                                                      |                                            |
...
| Keywords			            | Keywords                    | keyqords_fr           | string    | yes   |          | subject     | x |                                           | Comma separated keywords in French                                                                                               |                                            |
